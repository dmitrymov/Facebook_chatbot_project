		...
		public string publishStatus(FacebookClient fb)
		{
			...
			if (rand == 0)
			{
				using (StreamWriter w = File.AppendText(@"C:\Users\nati\Documents\Visual Studio 2010\Projects\facebook\facebook\logfile.txt"))
				{
					...
					int randomStatus = RandNumber.Next(55);
					parameters.message = getLine(@"C:\Users\nati\Documents\Visual Studio 2010\Projects\facebook\facebook\status.txt", randomStatus);
